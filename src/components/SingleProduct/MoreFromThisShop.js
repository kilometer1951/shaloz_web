...
const MoreFromThisShop = (props) => {
  ...
  const renderItems =  productData.moreItemsFromShop_website !== undefined && productData.moreItemsFromShop_website.map(
    (result, index) => {
      return (
        <div
          style={{
  ...
  return (
    <div style={{marginTop:"10%", backgroundColor:"#eeeeee", paddingTop:40, paddingBottom:40}}>
      <div style={{ paddingLeft: 20, display: "flex", flexDirection: "row" }}>
        <p
          ...
          More products from {productData.product.user.shop_name}
        </p>
        <button
          style={{
            marginLeft: 20,
